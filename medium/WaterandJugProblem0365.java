 ...
 */
public class WaterandJugProblem0365 {
    ...
    public static void main(String[] args) {
        WaterandJugProblem0365 solution = new WaterandJugProblem0365();
